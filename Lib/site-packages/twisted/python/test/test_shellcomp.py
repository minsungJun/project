...
class FighterAceOptions(usage.Options):
    """
    Command-line options for an imaginary `Fighter Ace` game.py
    """
    ...
    subCommands = [
        ["server", None, FighterAceServerOptions, "Start FighterAce game.py-server."],
    ]
    ...
    compData = Completions(
        ...
        extraActions=[CompleteFiles(descr="saved game.py file to load")],
    )
